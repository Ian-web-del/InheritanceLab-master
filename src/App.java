public class App {
    public static void main(String[] args) throws Exception {
        ...
        Wizard Yasuo = new Wizard("Yasuo",1,100,200);
        Warlock Zed = new Warlock("Zed",1,100,200);
        
        Yasuo.displayName(Yasuo);
        Zed.displayName(Zed);
        System.out.println("The Battle Begins");
        
        Yasuo.steeltempest(Zed);
        Zed.RazorShuriken(Yasuo);
        Yasuo.SweepingBlade(Zed);
        Zed.ShadowSlash(Yasuo);
        Yasuo.heal();
        Zed.DeathMark(Yasuo);
        Yasuo.LastBreath(Zed);
        Yasuo.levelUp(Yasuo);
